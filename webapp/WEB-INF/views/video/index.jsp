                ...
                <div class="container">
                    <div class="row">
                        <div class="col span_3">
                            <a id="logo" href="../index.html" data-supplied-ml-starting-dark="true"
                ...
                <div class="container main-content">
                    <div class="row">
                        <p id="breadcrumbs" class="yoast"><span><span>
                            <a href="../index.html">Home</a> » <span class="breadcrumb_last"
                                            ...
                                            <div class="page-submenu" data-bg-color="#000000" data-sticky="true"
                                                ...
                                                <div class="full-width-content"
                                                    ...
                                                    <ul style="background-color:#000000; color: #ffffff;">
                                                        <li><a href="#misson">미션</a></li>
                                                        <li><a href="#game">경기영상</a></li>
<!--                                                        <li><a href="#schedule">트레이닝 스케줄</a></li>-->
<!--                                                        <li><a href="#price">이용 요금</a></li>-->
                                                        <li><a href="#analysis">분석영상</a></li>
                                                       </ul>
                                                </div>
                                            </div>
                                        </div>
...
<!--                        </div>-->
                        ...
                        <!--미션영상-->
                        <div id="misson" data-column-margin="default" data-midnight="dark"
...
"
                        ...
                        <!--경기영상-->
                        <div id="game" data-column-margin="default" data-midnight="dark"
                             class="wpb_row vc_row-fluid vc_row full-width-section "
                             style="padding-top: 100px; padding-bottom: 100px; ">
                            <div class="row-bg-wrap" data-bg-animation="none" data-bg-overlay="false">
                                <div class="inner-wrap">
...
<!--                                            </div>-->
                                            ...
                                            <div id="fws_61c1ff4f70f85" data-midnight=""
                                                ...
                                                <div class="row_col_wrap_12_inner col span_12 left">
                                                    ...
                                                    <div class="vc_col-sm-8-1 wpb_column column_container vc_column_container col child_column no-extra-padding inherit_tablet inherit_phone "
                                                         data-padding-pos="all" data-has-bg-color="false"
                                                         data-bg-color="" data-bg-opacity="1"
                                                         data-animation="" data-delay="0">
                                                        <div class="vc_column-inner">
                        ...
                        <!--분석영상-->
                        <div id="analysis" data-column-margin="default" data-midnight="dark"
                             class="wpb_row vc_row-fluid vc_row full-width-section "
                             style="padding-top: 100px; padding-bottom: 100px; ">
                            <div class="row-bg-wrap" data-bg-animation="none" data-bg-overlay="false">
                                <div class="inner-wrap">
